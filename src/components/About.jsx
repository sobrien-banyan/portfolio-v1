  ...
  return (
    <div className='about-section'>
      ...
      <div className="w3-container w3-content w3-center w3-padding-64">
        ...
        Software Engineer focused on implementing excellent coding practices, adding value to projects, and learning the newest technologies. Proficient in React, Redux, Typescript, and Java along with other coding languages and libraries. Completed a six month Python and Django course at Columbia University. Consistently writing clean code. Works alongside other developers on various projects. Creating and maintaining large code bases. This site is built using the MERN (Mongo, Express, React, Node.js) stack. The front-end is hosted on Netlify. The back-end is running using Ubantu on an AWS EC2 instance. A context provider is used to pass the state around. Have fun by dragging the profile picture around, clicking on the name in the header or switching from light to dark theme.
        </p>
